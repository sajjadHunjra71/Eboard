...
//     if (page * ITEM_PER_PAGE >= DATA.length) {
//       return;
//     }
//     setTimeout(() => {
//       console.log(page * ITEM_PER_PAGE )
//       setPage(page + 1);
//       setData([...data, ...DATA.slice(page * ITEM_PER_PAGE, (page + 1) * ITEM_PER_PAGE)]);
//     }, 2000);
//   }
...
//       renderItem={({ item }) => (
//         <View style={{ height: 100, width: '90%', backgroundColor: 'gray', marginTop: 3 }}>
...
//       ListFooterComponent={
//         page * ITEM_PER_PAGE >= DATA.length
